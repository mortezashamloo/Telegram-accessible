...
حالت آپلود معمولاً وقتی `currentMessageObject.isOut()` و در حال ارسال فایل است؛  
دانلود وقتی `buttonState` مربوط به لود است (در کد فعلی اغلب `buttonState == 1` همراه `loadingProgressLayout`).
